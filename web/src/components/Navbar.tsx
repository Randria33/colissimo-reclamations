      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-4">
            <Link
              href={profile?.role === 'admin' ? '/dashboard' : '/chauffeur'}
            ...
            <Link
              href={profile?.role === 'admin' ? '/dashboard' : '/chauffeur'}
              className="flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg transition"
